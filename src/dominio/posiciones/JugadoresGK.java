...
public class JugadoresGK extends JFrame{
    JMenuBar menuBar;
    JMenu defensas;
    ...
    public JugadoresGK(){
        super("Ultimate Builder - GoalKeepers");
        ...
        try{
            ...
            ResultSet result = myStatement.executeQuery("SELECT nombre, posicion FROM Jugadores WHERE posicion = 'GK' ");
            String nombre;
            String posicion;
            while(result.next()) {
